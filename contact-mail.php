...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  //$mail->Password = 'qxhabehhelbuxyqh';
  ...
  $mail->Body = "Name: $name<br>Email: $email<br>Phone: $phone<br>Register: $register<br>Message: $message";
  ...
  if (!$mail->send()) {
    ...
    header('Location: https://trademarkroyalty.com/contact-us?submitted=1');
  }
}
?>
