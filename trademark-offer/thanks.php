...
<!-- Google tag (gtag.js) -->
        ...
        <script>
          ...
          gtag('event', 'conversion', {'send_to': 'AW-11222777118/ah3SCLyEpqwYEJ76t-cp'});
        ...
        <div class="row">
          <div class=col-md-6>
            <div class="logo-wrapper">
              <a href="/"><img style="width:120px; height:120px" src="query/assets/images/logo.png" class="img-fluid" alt="Logo"></a>
            </div>
          </div>
          <div class=col-md-6>
