...
<head>
    ...
    <title>Trademark Royalty - Form</title>
    ...
    <!--<link rel="stylesheet" href="css/jquery.uploader.css?v=1">-->
    ...
    <link rel="stylesheet" href="global.css?v=1.4">
...
<body>
            ...
            <section>
                <div class="wizard">
                    ...
                    <form method="post" action="#" id="form-upload" enctype="multipart/form-data">
                        ...
                        <input type="hidden" name="source" value="https://trademarkroyalty.com/trademark-offer">
                        <div class="tab-content">
                            <div class="tab-pane active" role="tabpanel" id="step1">
                                <div class="p-5 md:pt-8 md:p-10 flex flex-col gap-y-8 rounded-3xl w-full section-shadow bg-white">
                                    <div class="mt-3">
                                        ...
                                        <div class="grid md:grid-cols-2 gap-y-3 gap-x-5 items-center font-medium">
                                                        ...
                                                        <label class="form-control items-center cursor-pointer pl-2 pt-2 pb-2 justify-between pr-4">
                                                            <div>
                                                                <div class="flex md:items-center md:justify-center gap-5 py-1 md:py-3 px-2">
                                                                    <!--<span style="box-sizing: border-box; display: inline-block; overflow: hidden; width: initial; height: initial; background: none; opacity: 1; border: 0px; margin: 0px; padding: 0px; position: relative; max-width: 100%;"><span style="box-sizing: border-box; display: block; width: initial; height: initial; background: none; opacity: 1; border: 0px; margin: 0px; padding: 0px; max-width: 100%;"><img alt="" aria-hidden="true" src="./assets/image/nike_name.svg" style="display: block; max-width: 100%; width: initial; height: initial; background: none; opacity: 1; border: 0px; margin: 0px; padding: 0px;"></span><img src="./assets/images/nike_name.svg" decoding="async" data-nimg="intrinsic" style="position: absolute; inset: 0px; box-sizing: border-box; padding: 0px; border: none; margin: auto; display: block; width: 0px; height: 0px; min-width: 100%; max-width: 100%; min-height: 100%; max-height: 100%; object-fit: contain;"></span>-->
                                                ...
                                                <div class="opacity-100 lg:h-[88px] overflow-y-auto undefined">
                                                    <div class="border-[1.5px] rounded-[15px] text-tm-blue border-tm-blue  bg-blue-50">
                                                        <label class="form-control items-center cursor-pointer pl-2 pt-2 pb-2 justify-between pr-4">
                                                            <div>
                                                                <div class="flex md:items-center md:justify-center gap-5 py-1 md:py-3 px-2">
                                                                    <!--<span style="box-sizing: border-box; display: inline-block; overflow: hidden; width: initial; height: initial; background: none; opacity: 1; border: 0px; margin: 0px; padding: 0px; position: relative; max-width: 100%;"><span style="box-sizing: border-box; display: block; width: initial; height: initial; background: none; opacity: 1; border: 0px; margin: 0px; padding: 0px; max-width: 100%;"><img alt="" aria-hidden="true" src="./assets/image/nike_logo.svg" style="display: block; max-width: 100%; width: initial; height: initial; background: none; opacity: 1; border: 0px; margin: 0px; padding: 0px;"></span><img src="./assets/image/nike_logo.svg" decoding="async" data-nimg="intrinsic" style="position: absolute; inset: 0px; box-sizing: border-box; padding: 0px; border: none; margin: auto; display: block; width: 0px; height: 0px; min-width: 100%; max-width: 100%; min-height: 100%; max-height: 100%; object-fit: contain;"></span>-->
                                                                    <div class="flex flex-col justify-between">
                                                ...
                                                <div class=" lg:h-[88px] overflow-y-auto undefined , text-321">
                                                    <div class="border-[1.5px] rounded-[15px]  text-tm-blue border-tm-blue  bg-blue-50">
                                                        <label class="form-control items-center cursor-pointer pl-2 pt-2 pb-2 justify-between pr-4">
                                                            <div>
                                                                <div class="flex md:items-center md:justify-center gap-5 py-1 md:py-3 px-2">
                                                                    <!--<span style="box-sizing: border-box; display: inline-block; overflow: hidden; width: initial; height: initial; background: none; opacity: 1; border: 0px; margin: 0px; padding: 0px; position: relative; max-width: 100%;"><span style="box-sizing: border-box; display: block; width: initial; height: initial; background: none; opacity: 1; border: 0px; margin: 0px; padding: 0px; max-width: 100%;"><img alt="" aria-hidden="true" src="./assets/image/just_do_it.svg" style="display: block; max-width: 100%; width: initial; height: initial; background: none; opacity: 1; border: 0px; margin: 0px; padding: 0px;"></span><img src="./assets/image/just_do_it.svg" decoding="async" data-nimg="intrinsic" style="position: absolute; inset: 0px; box-sizing: border-box; padding: 0px; border: none; margin: auto; display: block; width: 0px; height: 0px; min-width: 100%; max-width: 100%; min-height: 100%; max-height: 100%; object-fit: contain;"></span>-->
                                                                    <div class="flex flex-col justify-between">
                                            ...
                                            <div>
                                                ...
                                                <!--            <div>-->
                                                <!--                <div class="flex md:items-center md:justify-center gap-5 py-1 md:py-3 px-2">-->
                                                <!--                    <span style="box-sizing: border-box; display: inline-block; overflow: hidden; width: initial; height: initial; background: none; opacity: 1; border: 0px; margin: 0px; padding: 0px; position: relative; max-width: 100%;"><span style="box-sizing: border-box; display: block; width: initial; height: initial; background: none; opacity: 1; border: 0px; margin: 0px; padding: 0px; max-width: 100%;"><img alt="" aria-hidden="true" src="./assets/image/music.svg" style="display: block; max-width: 100%; width: initial; height: initial; background: none; opacity: 1; border: 0px; margin: 0px; padding: 0px;"></span><img src="./assets/image/music.svg" decoding="async" data-nimg="intrinsic" style="position: absolute; inset: 0px; box-sizing: border-box; padding: 0px; border: none; margin: auto; display: block; width: 0px; height: 0px; min-width: 100%; max-width: 100%; min-height: 100%; max-height: 100%; object-fit: contain;"></span>-->
                                                <!--                    <div class="flex flex-col justify-between">-->
                                                <!--                        <p class="font-bold">Sound</p>-->
                                                <!--                        <p class="text-xs">Unique sounds identifying-->
                                                <!--                            your brand</p>-->
                                                <!--                    </div>-->
                                                <!--                </div>-->
                                                <!--            </div><input type="checkbox" name="trademark_information.is_sound_protected" class="undefined  !ring-transparent h-5 w-5 !rounded-[6px] bg-white checked:bg-tm-blue checked:border-tm-blue focus:outline-none transition duration-200 bg-no-repeat bg-center bg-contain float-left cursor-pointer" data-gtm-form-interact-field-id="1">-->
                                                <!--        </label>-->
                                                <!--    </div>-->
                                                <!--</div>-->
                                            </div>
                                            ...
                                            <div>
                                                <div id="imgId" class=" flex flex-col items-center justify-center mb-3 cursor-pointer">
                                                    <div role="presentation" tabindex="0" class="w-full">
                                                        <!--<input type="file" id="file" tabindex="-1" name="file" id="demo2" class="protect">-->
                                                        <!--<div class="img-fit">-->
                                                        ...
                                                        <div class="bg-[#F9F9F9] border-[#D3D3D3] border rounded-xl px-5 pt-10 pb-10 flex flex-col items-center justify-center">
                                                            <!--<span style="box-sizing: border-box; display: inline-block; overflow: hidden; width: initial; height: initial; background: none; opacity: 1; border: 0px; margin: 0px; padding: 0px; position: relative; max-width: 100%;"><span style="box-sizing: border-box; display: block; width: initial; height: initial; background: none; opacity: 1; border: 0px; margin: 0px; padding: 0px; max-width: 100%;"><img alt="" aria-hidden="true" src="./assets/image/image_upload.png" style="display: block; max-width: 100%; width: initial; height: initial; background: none; opacity: 1; border: 0px; margin: 0px; padding: 0px;"></span>-->
                                                            <!--<img alt="image upload" src="./assets/image/image_upload.png" decoding="async" data-nimg="intrinsic" style="position: absolute; inset: 0px; box-sizing: border-box; padding: 0px; border: none; margin: auto; display: block; width: 0px; height: 0px; min-width: 100%; max-width: 100%; min-height: 100%; max-height: 100%;"></span>-->

                                                            <h1>Upload logo or drag &amp; drop</h1>
                                                            <div class='preview'>
                                                                <!--<img src="upload/default.png" id="img" width="100" height="100">-->
                                                            </div>
                                                            <!--<input type="file" id="demo2" tabindex="-1" name="file" class="protect">-->
                                                            <input type="file" name="file" id="demo2" class="dropify protect" data-allowed-file-extensions="pdf png jpg jpeg webp" />

                                                            <!--<input type="text" id="demo2" tabindex="-1" name="file">-->
                                    ...
                                    <div class="mt-3">
                                        <h1 class="text-center font-semibold flex gap-x-1 mb-3"><span class="text-tm-red-required">*</span>Upload the sound you want to
                                            trademark:</h1>
                                        <div>
                                            <div>
                                                <div id="imgId" class=" flex flex-col items-center justify-center mb-3 cursor-pointer">
                                                    <div role="presentation" tabindex="0" class="w-full"><input multiple="" type="file" tabindex="-1" name="brand_sound">
                                                        <div class="bg-[#F9F9F9] border-[#D3D3D3] border rounded-xl px-5 pt-10 pb-10 flex flex-col items-center justify-center">
                                                            <!--<span style="box-sizing: border-box; display: inline-block; overflow: hidden; width: initial; height: initial; background: none; opacity: 1; border: 0px; margin: 0px; padding: 0px; position: relative; max-width: 100%;"><span style="box-sizing: border-box; display: block; width: initial; height: initial; background: none; opacity: 1; border: 0px; margin: 0px; padding: 0px; max-width: 100%;"><img alt="" aria-hidden="true" src="./assets/image/audio_upload.png" style="display: block; max-width: 100%; width: initial; height: initial; background: none; opacity: 1; border: 0px; margin: 0px; padding: 0px;"></span>-->
                                                            <!--    <img alt="image upload" src="./assets/image/audio_upload.png" decoding="async" data-nimg="intrinsic" style="position: absolute; inset: 0px; box-sizing: border-box; padding: 0px; border: none; margin: auto; display: block; width: 0px; height: 0px; min-width: 100%; max-width: 100%; min-height: 100%; max-height: 100%;"></span>-->
                                                            <h1>Upload sound or drag &amp; drop</h1>

                                                        </div>
                                                        <p style="text-align: center;" class="brandaudio"></p>
                                                    </div>
                                                </div>
                                            </div>
                            ...
                            <div class="tab-pane" role="tabpanel" id="step3">
                                ...
                                <!--<input type="name" placeholder="Street Address" name="address" class="undefined !ring-transparent h-5 w-5 !rounded-[6px] bg-white checked:bg-tm-blue checked:border-tm-blue focus:outline-none transition duration-200 bg-no-repeat bg-center bg-contain float-left cursor-pointer" />-->
                            ...
                            <div class="tab-pane" role="tabpanel" id="step4">
                                <div class="mt-3">
                                    ...
                                    <!--<div class="rounded-[40px] overflow-auto" style="box-shadow: rgba(222, 222, 222, 0.08) 0px 10px 10px, rgba(100, 106, 114, 0.12) 0px 10px 70px;">-->
                                        <table style="box-shadow: rgba(222, 222, 222, 0.08) 0px 10px 10px, rgba(100, 106, 114, 0.12) 0px 10px 70px; width: 85%; margin: 0 auto;">
                                            <thead>
                                                <tr>
                                                    <th class="bg-[#F8FAFF] border-r-4 border-r-[#EEF3FF] rouned-l-[40px]">
                                                        <!--<span style="box-sizing: border-box; display: inline-block; overflow: hidden; width: initial; height: initial; background: none; opacity: 1; border: 0px; margin: 0px; padding: 0px; position: relative; max-width: 100%;"><span style="box-sizing: border-box; display: block; width: initial; height: initial; background: none; opacity: 1; border: 0px; margin: 0px; padding: 0px; max-width: 100%;"><img alt="" aria-hidden="true" src="data:image/svg+xml,%3csvg%20xmlns=%27http://www.w3.org/2000/svg%27%20version=%271.1%27%20width=%27100%27%20height=%2780%27/%3e" style="display: block; max-width: 100%; width: initial; height: initial; background: none; opacity: 1; border: 0px; margin: 0px; padding: 0px;"></span><img class="trademarrk-img" src="..assets/images/logo-lp.png" alt=""></span>-->
                                                    </th>
                                                    <th class="align-bottom">
                                                        <div class="flex flex-col items-center  gap-y-1 py-5 px-3 items-start border-b-2 border-b-[#E2E2E2] package-selected-pay">
                                                            ...
                                                            <p class="font-bold text-4xl">$39<span class="text-base">/class</span></p>
                                                            <strike>$78</strike>
                                                            <div class="flex justify-center mt-2">
                                                                <button class="custom-package-btn py-2 px-3 md:py-3.5 md:px-8 font-bold flex items-center justify-center rounded-lg md:rounded-2xl relative overflow-hidden disabled:border-tm-gray-300 disabled:bg-tm-gray-300 disabled:hover:bg-tm-gray-300 disabled:cursor-not-allowed focus-visible:outline-none !px-8 !py-2 !rounded-base border border-solid border-tm-blue bg-tm-blue hover:bg-tm-royal-blue active:bg-tm-blue-200 text-white " type="button"><span class="button_ripple__Kgdu_" style="height: 147px; width: 147px; left: 22.5px; top: -49.5px;"></span>
                                                                    <input required="" type="radio" value="39" name="package_price" data-package_name="Basic" class="package-select" id="box1">
                                                    ...
                                                    <th class="align-bottom">
                                                        <div class="flex flex-col items-center  gap-y-1 py-5 px-3 items-start border-b-2 border-b-[#E2E2E2] package-selected-pay">
                                                            <p class="font-semibold package_name">Startup</p>
                                                            <p class="font-bold text-4xl">$149<span class="text-base">/class</span></p>
                                                            <strike>$298</strike>
                                                            <div class="flex justify-center mt-2">
                                                                <button class="custom-package-btn py-2 px-3 md:py-3.5 md:px-8 font-bold flex items-center justify-center rounded-lg md:rounded-2xl relative overflow-hidden disabled:border-tm-gray-300 disabled:bg-tm-gray-300 disabled:hover:bg-tm-gray-300 disabled:cursor-not-allowed focus-visible:outline-none !px-8 !py-2 !rounded-base border border-solid border-tm-blue bg-tm-blue hover:bg-tm-royal-blue active:bg-tm-blue-200 text-white " type="button"><span class="button_ripple__Kgdu_" style="height: 147px; width: 147px; left: 22.5px; top: -49.5px;"></span>
                                                                    <input required="" type="radio" value="149" name="package_price" data-package_name="Startup" class="package-select" id="box2">
                                                                    <p class="font-bold whitespace-nowrap">
                                                                    </p>
                                                                    <p class="cursor-pointer">Select Plan</p>
                                                                    <p></p>
                                                    ...
                                                    <th class="align-bottom">
                                                        <div class="flex flex-col items-center  gap-y-1 py-5 px-3 items-start border-b-2 border-b-[#E2E2E2] package-selected-pay">
                                                            <p class="font-semibold package_name">Premium</p>
                                                            <p class="font-bold text-4xl">$249<span class="text-base">/class</span></p>
                                                            <strike>$498</strike>
                                                            <div class="flex justify-center mt-2">
                                                                <button class="custom-package-btn py-2 px-3 md:py-3.5 md:px-8 font-bold flex items-center justify-center rounded-lg md:rounded-2xl relative overflow-hidden disabled:border-tm-gray-300 disabled:bg-tm-gray-300 disabled:hover:bg-tm-gray-300 disabled:cursor-not-allowed focus-visible:outline-none !px-8 !py-2 !rounded-base border border-solid border-tm-blue bg-tm-blue hover:bg-tm-royal-blue active:bg-tm-blue-200 text-white " type="button"><span class="button_ripple__Kgdu_" style="height: 147px; width: 147px; left: 22.5px; top: -49.5px;"></span>
                                                                    <input required="" type="radio" value="249" name="package_price" data-package_name="Premium" class="package-select">
                                                    ...
                                                    <th class="align-bottom">
                                                        <div class="flex flex-col items-center gap-y-1 py-5 px-3 items-start border-b-2 border-b-[#E2E2E2] package-selected-pay">
                                                            ...
                                                            <p class="font-bold text-4xl">$449<span class="text-base">/class</span></p>
                                                            <strike>$998</strike>
                                                            <div class="flex justify-center mt-2">
                                                                <button class="custom-package-btn py-2 px-3 md:py-3.5 md:px-8 font-bold flex items-center justify-center rounded-lg md:rounded-2xl relative overflow-hidden disabled:border-tm-gray-300 disabled:bg-tm-gray-300 disabled:hover:bg-tm-gray-300 disabled:cursor-not-allowed focus-visible:outline-none !px-8 !py-2 !rounded-base border border-solid border-tm-blue bg-tm-blue hover:bg-tm-royal-blue active:bg-tm-blue-200 text-white " type="button"><span class="button_ripple__Kgdu_" style="height: 147px; width: 147px; left: 22.5px; top: -49.5px;"></span>
                                                                    <input required="" type="radio" value="449" name="package_price" data-package_name="Corporate" class="package-select">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td class="flex items-center bg-[#F8FAFF] border-r-4 border-r-[#EEF3FF] px-8 py-5">
    ...
    <script src="custom.js?v=1.1"></script>
</body>
...
<script>
    ...
    $('input.package-select').change(function() {
        $('input.package-select').parent().parent().parent().removeClass('bg-tm-orange text-white')

        if ($(this).is(':checked')) {
            $(this).parent().parent().parent().addClass('bg-tm-orange text-white')
        } else {
            $(this).parent().parent().parent().removeClass('bg-tm-orange text-white')
        }
    ...
    $('input[type="checkbox"]').change(function() {
        if ($('input[type="checkbox"]').eq(0).is(':checked')) {
            $('input[type="checkbox"]').eq(0).parent().css('background', '#EFF6FF');
            $('.mt-3').eq(1).show();
            // $('.mt-3').eq(1).find('input').attr('required','true')

        } else {
            $('input[type="checkbox"]').eq(0).parent().css('background', '#fff');
            $('.mt-3').eq(1).hide();
            // $('.mt-3').eq(1).find('input').removeAttr('required')
        }
        ...
        if ($('input[type="checkbox"]').eq(2).is(':checked')) {
            $('input[type="checkbox"]').eq(2).parent().css('background', '#EFF6FF');
            $('.mt-3').eq(3).show();
            //  $('.mt-3').eq(2).find('input').attr('required','true')
        } else {
            $('input[type="checkbox"]').eq(2).parent().css('background', '#fff');
            $('.mt-3').eq(3).hide();
            // $('.mt-3').eq(2).find('input').removeAttr('required')
        }
    ...
    //     if($('input[name="brand_name"]').val().length === 0){
    //         $('.next-step').attr('disabled','true')
    //          $('#step1 li').css('cursor','no-drop')

    //     }
    //     else{
    //          $('.next-step').removeAttr('disabled','true')
    //           $('#step1 li').css('cursor','pointer')
    ...
    // setInterval(function(){
    //     if($('input[name="brand_slogan"]').val().length === 0){
    //         $('.next-step').attr('disabled','true')
    //         $('#step1 li').css('cursor','no-drop')
    ...
    // $('.tab-pane').on('DOMSubtreeModified', function() {
    //     var step4Div = $('#step4');
    //   if (step4Div.hasClass('active')) {
    //         $('.package-select').eq(1).click()
    //     } else {
    //       $('.package-select').eq(1).removeAttr('checked','true')
    //     }
    // });
</script>
...
<script>
    ...
    // $('#step1 input[name="trademark_slogan"], #step1 input[type="text"]').on('change keyup', function () {
    //     var checkboxChecked = $('.mt-3').eq(3).hasClass('active');
    //     var inputValue = $('#step1 input[name="brand_slogan"]').val().trim();

    //     if (checkboxChecked && (inputValue !== '')) {
    ...
    // $('#step1 .next-step').attr('disabled', 'true');
    // $('#step1 input[name="trademark_name"], #step1 input[type="text"]').on('change keyup', function () {
    //     var checkboxChecked = $('.mt-3').eq(1).hasClass('active');
    //     var inputValue = $('#step1 input[name="brand_name"]').val().trim();
    ...
    // $('#step2 textarea[name="brand_description"]').on('change keyup', function () {
    //     var inputValue = $('#step2 textarea[name="brand_description"]').val().trim();
...
<!--<button-->
<!--  style="padding: 0 !important; height: 40px !important; width: 122px !important; color: white; font-weight: 700; background: #4380ec; border: none; border-radius: 10px;"-->
<!--  id=""-->
<!--  role="link"-->
<!--  type="button"-->
...
<script>
    // (function() {
    //   var stripe = Stripe('pk_live_51N73b9AOjPLj3NFv5iTmAfJZnyqziOsF9RxFLJGRPebQgG4BYoaJl5ggUnXLMast04kjhFu0YQIjNy1UqIqfmNNs00D6TdywlG');

    //   var checkoutButton = document.getElementById('checkout-button-price_1NER2yAOjPLj3NFvWF58pqOP');
    ...
    //       lineItems: [{price: 'price_1NER2yAOjPLj3NFvWF58pqOP', quantity: 1}],
    //       mode: 'payment',
    //       /*
    ...
    //       */
    //       successUrl: 'https://vizfirm.com/vizfirm-lp/thanks.php',
    //       cancelUrl: 'https://vizfirm.com/vizfirm-lp/form.php',
    //     })
